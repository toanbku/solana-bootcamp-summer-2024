...
(async () => {
  ...
  const metadata = {
    name: "Toan Ho NFT",
    symbol: "THQ",
    description: "Toan Ho NFT",
    attributes: [{ trait_type: "Accessory", value: "Vodo" }],
    image:
      "https://github.com/toanbku/solana-bootcamp-summer-2024/blob/main/assets/logo.png?raw=true",
  };
